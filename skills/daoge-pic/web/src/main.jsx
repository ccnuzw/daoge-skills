...
import { WorkbenchShell } from './app/workbench-shell.jsx';
...
await refresh();
  ...
  return <WorkbenchShell EMPTY={EMPTY} ImageInspectorDialog={ImageInspectorDialog} addAssetsToCurrentRoundReferences={addAssetsToCurrentRoundReferences} agentConnection={agentConnection} agentDetection={agentDetection} agentDetectionLoading={agentDetectionLoading} agentPresenceStatus={agentPresenceStatus} answerRequest={answerRequest} assetProvenance={assetProvenance} brandKits={brandKits} canImport={canImport} canvasSelectedAssetIds={canvasSelectedAssetIds} chooseReferenceRound={chooseReferenceRound} chooseReferenceTask={chooseReferenceTask} confirmGenerationPlan={confirmGenerationPlan} confirmPendingAction={confirmPendingAction} confirmation={confirmation} confirmationBusy={confirmationBusy} confirmationError={confirmationError} confirmationPlanSummary={confirmationPlanSummary} copyRuntimeDiagnostic={copyRuntimeDiagnostic} createDerivedRoundFromAssets={createDerivedRoundFromAssets} createProjectFromStudio={createProjectFromStudio} createRoundForPendingReference={createRoundForPendingReference} createRoundFromStudio={createRoundFromStudio} createTaskFromStudio={createTaskFromStudio} creationBusy={creationBusy} creationDialog={creationDialog} creationError={creationError} currentLayoutTier={currentLayoutTier} derivedBusy={derivedBusy} derivedDialog={derivedDialog} derivedError={derivedError} detectAgents={detectAgents} dismissConfirmation={dismissConfirmation} dismissCreationDialog={dismissCreationDialog} dismissDerivedDialog={dismissDerivedDialog} dismissGenerationConfirmation={dismissGenerationConfirmation} dismissReferenceDialog={dismissReferenceDialog} dismissReferenceResolver={dismissReferenceResolver} dismissRejectDialog={dismissRejectDialog} generationConfirmation={generationConfirmation} generationConfirmationBusy={generationConfirmationBusy} generationConfirmationError={generationConfirmationError} importDerivedMaskAsset={importDerivedMaskAsset} inputRef={inputRef} layoutAuditEnabled={layoutAuditEnabled} markAsDeliverable={markAsDeliverable} navigateRoute={navigateRoute} openDerivedRoundDialog={openDerivedRoundDialog} openProviderDetails={openProviderDetails} openReferenceDialog={openReferenceDialog} openRejectReviewDialog={openRejectReviewDialog} openRoundFromQueue={openRoundFromQueue} openRoundPlanEdit={openRoundPlanEdit} openSearchResult={openSearchResult} pendingRequestCount={pendingRequestCount} previewAssets={previewAssets} previewZoom={previewZoom} progressForRequest={progressForRequest} projectTemplates={projectTemplates} projects={projects} provider={provider} providerDetails={providerDetails} providerNotice={providerNotice} railCollapsed={railCollapsed} recoveryPhase={recoveryPhase} referenceBusy={referenceBusy} referenceDialog={referenceDialog} referenceError={referenceError} referenceMaterials={referenceMaterials} referenceResolver={referenceResolver} refresh={refresh} rejectBusy={rejectBusy} rejectDialog={rejectDialog} rejectError={rejectError} renderActiveView={renderActiveView} repairRuntime={repairRuntime} requestBusy={requestBusy} restoreSessionContext={restoreSessionContext} rounds={rounds} route={route} routeView={routeView} runtimeRepairing={runtimeRepairing} saveRejectReview={saveRejectReview} saveRoundReferenceMaterials={saveRoundReferenceMaterials} searchError={searchError} searchLoading={searchLoading} searchQuery={searchQuery} searchResults={searchResults} selectedAssetIds={selectedAssetIds} selectedProject={selectedProject} selectedRound={selectedRound} selectedTask={selectedTask} selectionBusyIds={selectionBusyIds} sendRequest={sendRequest} sessionPlanStatus={sessionPlanStatus} setAssetProvenance={setAssetProvenance} setPreviewAssets={setPreviewAssets} setPreviewZoom={setPreviewZoom} setProviderDetails={setProviderDetails} setRailCollapsed={setRailCollapsed} setSearchQuery={setSearchQuery} sharedAssets={sharedAssets} statusItems={statusItems} studio={studio} studioRequests={studioRequests} studioView={studioView} styleKits={styleKits} surfaceEyebrow={surfaceEyebrow} surfaceSubtitle={surfaceSubtitle} surfaceTitle={surfaceTitle} taskForId={taskForId} taskTypes={taskTypes} tasks={tasks} updateAgentConnection={updateAgentConnection} upload={upload} view={view} withdrawRequest={withdrawRequest} />
}
