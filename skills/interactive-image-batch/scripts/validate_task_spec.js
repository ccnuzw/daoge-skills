...
function main() {
  ...
  if (width % 16 !== 0) throw new Error(`task_spec.width must be a multiple of 16: received ${width}`);
  if (height % 16 !== 0) throw new Error(`task_spec.height must be a multiple of 16: received ${height}`);
