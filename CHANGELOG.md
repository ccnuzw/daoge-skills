...
- 本地候选制品 `daoge-pic-5.10.4.tgz` 为 `350702` bytes，SHA-256 为 `984da60c5997519860a52acac282af6eba4678a7aa2a4808f4c46a94cc63b6f9`；Skill 协议保持 `2.0.0`，运行时兼容下限为 `>=5.10.4 <6.0.0`。
