import { Activity, CircleAlert, Copy, FolderKanban, PanelTop, RefreshCw, Search, X } from 'lucide-react';
...
export function ManagedTaskList({ tasks, pageSize, actionLabel, emptyMessage, onOpenTask }) {
  const [query, setQuery] = useState('');
