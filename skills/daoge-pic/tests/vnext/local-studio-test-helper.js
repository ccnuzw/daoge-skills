function studioHeaders(started, headers = {}) {
  return { authorization: 'Bearer ' + started.access.bearerToken, 'x-daoge-skill-protocol': 'daoge-pic-skill-protocol/3.0.0', ...headers };
}
