...
- 本地候选制品 `daoge-pic-5.10.4.tgz` 为 `350750` bytes，SHA-256 为 `4f5abffcf10a2fb60b3831f8c38f53914f53717c3006c217767cdfd60782444b`；Skill 协议保持 `2.0.0`，运行时兼容下限为 `>=5.10.4 <6.0.0`。
